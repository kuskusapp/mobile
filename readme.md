Mobile app for [KusKus](https://kuskus.app/) built with [Expo](https://github.com/expo/expo) and [Tamagui](https://tamagui.dev/) for styling.

Builds on top of [Tamagui Expo Template](https://github.com/ivopr/tamagui-expo).
...
Download [Expo Go app](https://expo.dev/client). Scan QR code with camera app (iOS) and open the app.

Update code, it will hot reload.
